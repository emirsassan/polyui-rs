...
// import AppLogo from '@polyui/assets/images/logo.png';
			...
			<div className="relative flex max-w-[100rem] mx-auto items-center h-full m-auto p-5">
				...
				>
					<Dropdown.Section>
						<Dropdown.Item
							icon={Github}
							onClick={redirect('https://github.com/polyfrost/polyfrost')}
						>
							Repository
						</Dropdown.Item>
				...
				<div className="absolute flex-row hidden space-x-5 right-3 lg:flex">
					...
					<a href="https://github.com/polyfrost/polyfrost" target="_blank" rel="noreferrer">
