...
pub fn get_lib_path(libraries_path: &Path, lib: &str) -> crate::error::Result<String> {
...
pub fn get_jvm_arguments(
    ...
    if let Some(args) = arguments {
        ...
        parsed_arguments.push(format!(
            ...
            &natives_path
                .canonicalize()
                .map_err(|_| crate::error::CoreErrors::LauncherError(format!(
...
where
    F: Fn(&str) -> crate::error::Result<String>,
{
...
pub async fn get_processor_main_class(
    ...
    Ok(tokio::task::spawn_blocking(move || {
        ...
        Ok::<Option<String>, crate::error::Error>(None)
    })
    .await
    .unwrap()?)
}