...
import { MicrosoftErrorCode, MicrosoftResponse, decipherErrorCode } from './MicrosoftResponse';
...
export class MicrosoftAuth {
	...
	public static readonly TOKEN_ENDPOINT =
	...
	public static readonly MC_AUTH_ENDPOINT =
		'https://api.minecraftservices.com/authentication/login_with_xbox';
	public static readonly MC_ENTITLEMENT_ENDPOINT =
		'https://api.minecraftservices.com/entitlements/mcstore';
	public static readonly MC_PROFILE_ENDPOINT =
	...
	private static handleGotError<T>(
		...
		const response: MicrosoftResponse<T> = handleGotError(
			operation,
			error,
			MicrosoftAuth.logger,
			dataProvider
		);
	...
	public static async getAccessToken(
		...
		refresh: boolean,
		clientId: string
	): Promise<MicrosoftResponse<AuthorizationTokenResponse | null>> {
		try {
			...
			return MicrosoftAuth.handleGotError(
				`Get ${refresh ? 'Refresh' : 'Auth'} Token`,
	 ...
	 */
	public static async getXBLToken(
		accessToken: string
	): Promise<MicrosoftResponse<XboxServiceTokenResponse | null>> {
		try {
			// TODO TYPE REQUEST
	 ...
	 */
	public static async getXSTSToken(
		xblResponse: XboxServiceTokenResponse
	): Promise<MicrosoftResponse<XboxServiceTokenResponse | null>> {
		try {
			// TODO TYPE REQUEST
	 ...
	 */
	public static async getMCAccessToken(
		xstsResponse: XboxServiceTokenResponse
	): Promise<MicrosoftResponse<MCTokenResponse | null>> {
		try {
			// TODO TYPE REQUEST
	 ...
	 */
	public static async getMCProfile(
		mcAccessToken: string
	): Promise<MicrosoftResponse<MCUserInfo | null>> {
		try {
