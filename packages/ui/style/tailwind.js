...
module.exports = function (app, options) {
	let config = {
		content: [
			!options?.ignorePackages && '../../packages/*/src/**/*.{astro,html,js,jsx,md,mdx,svelte,ts,tsx,vue}',
			app ? `../../apps/${app}/src/**/*.{astro,html,js,jsx,md,mdx,svelte,ts,tsx,vue}` : `./src/**/*.{astro,html,js,jsx,md,mdx,svelte,ts,tsx,vue}`
		],
			...
			extend: {
				...
				colors: {
					brand: '#0A5BE8' && {
						hover: '#3477EB',
						pressed: '#4086FF',
						emphasis: 'linear-gradient(#0A5BE8 100%,#00348E 100%)'
					}
				},
				extend: {
